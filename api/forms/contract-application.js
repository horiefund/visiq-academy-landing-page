...
const REQUIRED_FIELDS = ["保護者名", "メールアドレス", "電話番号", "お子さま氏名", "学年", "希望コース"];
...
async function resolveParentMasterRecordId({ baseId, apiKey, fields }) {
  ...
  sendDebugLog({
    runId: "run-ca-3",
    hypothesisId: "H7",
    location: "api/forms/contract-application.js:resolveParentMasterRecordId",
  ...
  if (existingRecordId) {
    sendDebugLog({
      runId: "run-ca-3",
      hypothesisId: "H7",
      location: "api/forms/contract-application.js:resolveParentMasterRecordId:matched",
    ...
    sendDebugLog({
      runId: "run-ca-3",
      hypothesisId: "H9",
      location: "api/forms/contract-application.js:resolveParentMasterRecordId:duplicatePolicy",
  ...
  sendDebugLog({
    runId: "run-ca-3",
    hypothesisId: "H7",
    location: "api/forms/contract-application.js:resolveParentMasterRecordId:create",
  ...
  sendDebugLog({
    runId: "run-ca-3",
    hypothesisId: "H7",
    location: "api/forms/contract-application.js:resolveParentMasterRecordId:created",
...
function normalizeFields(rawFields) {
  ...
  if (fields["お子さま氏名"] === undefined && fields["お子様氏名"] !== undefined) {
    fields["お子さま氏名"] = fields["お子様氏名"];
    delete fields["お子様氏名"];
  }
  if (fields["規約同意"] === undefined && fields["同意する"] !== undefined) {
    fields["規約同意"] = fields["同意する"];
    delete fields["同意する"];
  }
  if (Array.isArray(fields["規約同意"])) {
    fields["規約同意"] = fields["規約同意"][0] || "";
  }
  return fields;
}
...
async function handler(req, res) {
  ...
  try {
    ...
    sendDebugLog({
      runId: "run-ca-2",
      hypothesisId: "H6",
      location: "api/forms/contract-application.js:envCheck",
    ...
    sendDebugLog({
      runId: "run-ca-3",
      hypothesisId: "H8",
      location: "api/forms/contract-application.js:beforeCreate",
      message: "Prepared fields before contract-application create",
      data: {
    ...
    sendDebugLog({
      runId: "run-ca-1",
      hypothesisId: "H3",
      location: "api/forms/contract-application.js:airtableCreateRecord",
    ...
    sendDebugLog({
      runId: "run-ca-1",
      hypothesisId: "H5",
      location: "api/forms/contract-application.js:catch",
